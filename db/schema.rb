...
ActiveRecord::Schema[7.0].define(version: 2023_03_08_115657) do
  ...
  add_foreign_key "games", "users", column: "first_user_id"
  add_foreign_key "games", "users", column: "second_user_id"
